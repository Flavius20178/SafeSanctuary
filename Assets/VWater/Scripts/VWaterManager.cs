...
namespace Vertigo2
{
    public class VWaterManager : MonoBehaviour
    {
        ...
        public static List<VWaterBase> activeWater = new();

        [Header("References")] public VWaterDynamicsManager dynamicsManager;
        ...
        [Space(10)] public GameObject splashPrefab_bullet;

        [Space(10)] public GameObject splashPrefab_footstep;

        [Header("Options")] [Tooltip("Speed at which objects will cause a splash")]
        ...
        public void Splash(VWaterBase water, VWaterBody body)
        {
            if (Mathf.Abs(body.velocity.y) > splashVelocity)
            {
                ...
                var heavy = Mathf.Abs(body.velocity.y) > heavySplashVelocity;
                ...
                if (body.mainCollider.bounds.size.magnitude > 3.5f)
                {
                    ...
                    if (heavy)
                    {
                        ...
                        if (wov != null && wov.splashPrefab_Large_Heavy != null)
                            splashPrefab = wov.splashPrefab_Large_Heavy;
                    }
                    else
                    {
                        splashPrefab = splashPrefab_Large_Light;
                        if (wov != null && wov.splashPrefab_Large_Light != null)
                            splashPrefab = wov.splashPrefab_Large_Light;
                    }
                }
                else if (body.mainCollider.bounds.size.magnitude < 1f)
                {
                    ...
                    if (heavy)
                    {
                        ...
                        if (wov != null && wov.splashPrefab_Small_Heavy != null)
                            splashPrefab = wov.splashPrefab_Small_Heavy;
                    }
                    else
                    {
                        splashPrefab = splashPrefab_Small_Light;
                        if (wov != null && wov.splashPrefab_Small_Light != null)
                            splashPrefab = wov.splashPrefab_Small_Light;
                    }
                }
                else
                {
                    ...
                    if (heavy)
                    {
                        ...
                        if (wov != null && wov.splashPrefab_Med_Heavy != null)
                            splashPrefab = wov.splashPrefab_Med_Heavy;
                    }
                    else
                    {
                        splashPrefab = splashPrefab_Med_Light;
                        if (wov != null && wov.splashPrefab_Med_Light != null)
                            splashPrefab = wov.splashPrefab_Med_Light;
                    }
                }

                if (splashPrefab == null) splashPrefab = splashPrefab_Med_Light; // default to med if prefabs missing

                var spawnPos = body.mainCollider.bounds.center;
        ...
        {
            var splashPrefab =
                water != null && water.waterOverride != null && water.waterOverride.splashPrefab_bullet != null
                    ? water.waterOverride.splashPrefab_bullet
                    : splashPrefab_bullet;
        ...
        {
            var splashPrefab =
                water != null && water.waterOverride != null && water.waterOverride.splashPrefab_footstep != null
                    ? water.waterOverride.splashPrefab_footstep
                    : splashPrefab_footstep;
            Instantiate(splashPrefab, position, splashPrefab.transform.rotation);
        }
    }
}