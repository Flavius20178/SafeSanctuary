...
public class AS_Offers : EditorWindow
{
    ...
    private void OnGUI()
    {
        var border = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/border.psd") as Texture2D;
        var ad1 = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/ad1.psd") as Texture2D;
        var ad2 = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/ad2.psd") as Texture2D;
        var ad3 = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/ad3.psd") as Texture2D;
...
public class Startup
{
    static Startup()
    {
        ...
        // Rate me
        EditorPrefs.SetInt("showCounts_rateTreePack2017n", EditorPrefs.GetInt("showCounts_rateTreePack2017n") + 1);
        if (EditorPrefs.GetInt("showCounts_rateTreePack2017n") == 30)
