...
public class Rate_Me : EditorWindow
{
    ...
    private void OnGUI()
    {
        var border = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/Rate_Border.psd") as Texture2D;
        var ad1 = EditorGUIUtility.Load("Assets/TreePackVol.1/Editor/Textures/UI/Ads/Rate_Asset.psd") as Texture2D;
