...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class ObjectResetPlane : MonoBehaviour
    {
        ...
        private readonly List<Pose> m_OriginalPositions = new();
        ...
        protected void Update()
        {
            ...
            for (var transformIndex = 0; transformIndex < m_ObjectsToReset.Count; transformIndex++)
            {
                ...
                if (currentTransform.position.y < resetPlane)
                {
                    ...
                    if (rigidBody != null) StartCoroutine(ResetRigidbodyRoutine(rigidBody));
                }
            }
        }

        private IEnumerator ResetRigidbodyRoutine(Rigidbody body)
        {
