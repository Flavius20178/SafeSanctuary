...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class PokeBlendShapeAnimator : MonoBehaviour
    {
        ...
        private float m_BlendShapeMin;

        [SerializeField] [Tooltip("The maximum blend shape value.")]
        private float m_BlendShapeMax = 100f;

        private readonly BindingsGroup m_BindingsGroup = new();
#pragma warning disable CS0618 // Type or member is obsolete
        private readonly FloatTweenableVariable m_TweenableVariable = new();
