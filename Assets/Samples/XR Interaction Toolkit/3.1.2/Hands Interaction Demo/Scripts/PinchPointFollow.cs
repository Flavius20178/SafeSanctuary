...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class PinchPointFollow : MonoBehaviour
    {
        ...
        private Transform m_TargetRotation;
...
#pragma warning disable CS0414 // Field assigned but its value is never used -- Keep to retain serialized value when XR Hands is not installed
        private float m_RotationSmoothingSpeed = 12f;
#pragma warning restore CS0414

#if XR_HANDS_1_2_OR_NEWER
        private bool m_HasTargetRotationTransform;
        private IXRRayProvider m_RayProvider;
        private bool m_HasRayProvider;
        private OneEuroFilterVector3 m_OneEuroFilterVector3;

#pragma warning disable CS0618 // Type or member is obsolete
        private readonly QuaternionTweenableVariable m_QuaternionTweenableVariable = new();
...
#if XR_HANDS_1_2_OR_NEWER
        private static bool TryGetPinchPosition(XRHandJointsUpdatedEventArgs args, out Vector3 position)
        {
