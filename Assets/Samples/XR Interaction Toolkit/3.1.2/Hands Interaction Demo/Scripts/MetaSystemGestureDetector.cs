...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    /// <remarks>
    ///     See
    ///     <see href="https://docs.unity3d.com/Packages/com.unity.xr.hands@1.1/manual/features/metahandtrackingaim.html">
    ///         Meta
    ///         Hand Tracking Aim
    ///     </see>
    ///     .
    ...
    public class MetaSystemGestureDetector : MonoBehaviour
    {
        ...
        [SerializeField]
        private InputActionProperty m_AimFlagsAction = new(new InputAction(expectedControlType: "Integer"));

        [SerializeField] private UnityEvent m_SystemGestureStarted;

        [SerializeField] private UnityEvent m_SystemGestureEnded;

        [SerializeField] private UnityEvent m_MenuPressed;

        private readonly BindableEnum<SystemGestureState> m_SystemGestureState = new(checkEquality: false);
        ...
        private MetaAimFlags m_AimFlags;
#endif

        private bool m_AimFlagsBound;
        ...
        ///         <item>
        ///             <description>
        ///                 <c>&lt;MetaAimHand&gt;{LeftHand}/aimFlags</c>
        ///             </description>
        ///         </item>
        ///         <item>
        ///             <description>
        ///                 <c>&lt;MetaAimHand&gt;{RightHand}/aimFlags</c>
        ///             </description>
        ///         </item>
        ///     </list>
        /// </remarks>
        ...
        private void SetGestureState(SystemGestureState state, bool forceInvoke)
        {
...
#if XR_HANDS_1_1_OR_NEWER && (ENABLE_VR || UNITY_GAMECORE)
        private void UpdateAimFlags(MetaAimFlags value, bool forceInvoke = false)
        {
            ...
            if (!hadMenuPressed && hasMenuPressed) m_MenuPressed?.Invoke();
        ...
        private void OnAimFlagsActionPerformedOrCanceled(InputAction.CallbackContext context)
        {
#if XR_HANDS_1_1_OR_NEWER && (ENABLE_VR || UNITY_GAMECORE)
