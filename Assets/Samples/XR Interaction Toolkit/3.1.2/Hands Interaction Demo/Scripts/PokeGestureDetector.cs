...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class PokeGestureDetector : MonoBehaviour
    {
        ...
        /// <returns>
        ///     Returns <see langword="true" /> if the bit field or bit fields are set, otherwise returns
        ///     <see langword="false" />.
        /// </returns>
        private static bool HasUpdateSuccessFlag(XRHandSubsystem.UpdateSuccessFlags successFlags,
        ...
        /// <returns>
        ///     True if the given hand's index finger tip is farther from the wrist than the index intermediate joint, false
        ///     otherwise.
        /// </returns>
        ...
        /// <param name="hand">Hand to check for the required pose.</param>
        /// <returns>
        ///     True if the given hand's middle finger tip is closer to the wrist than the middle proximal joint, false
        ///     otherwise.
        /// </returns>
        ...
        /// <param name="hand">Hand to check for the required pose.</param>
        /// <returns>
        ///     True if the given hand's little finger tip is closer to the wrist than the little proximal joint, false
        ///     otherwise.
        /// </returns>
        ...
        private void StartPokeGesture()
        {
            m_IsPoking = true;
            m_PokeGestureStarted.Invoke();
        }

        private void EndPokeGesture()
        {
            m_IsPoking = false;
