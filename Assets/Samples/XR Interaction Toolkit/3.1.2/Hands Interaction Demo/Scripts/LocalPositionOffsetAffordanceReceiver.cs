...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    public class LocalPositionOffsetAffordanceReceiver : Vector3AffordanceReceiver
    {
        ...
        private Transform m_TransformToTranslate;

        private bool m_HasTransformToTranslate;
        private float3 m_InitialOffset = float3.zero;
        ...
        {
            if (m_HasTransformToTranslate) m_InitialOffset = m_TransformToTranslate.localPosition;
        ...
        {
            if (m_HasTransformToTranslate) m_TransformToTranslate.localPosition = m_InitialOffset + newValue;
