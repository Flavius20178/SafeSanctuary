...
public class ConifersInstaller : EditorWindow
{
    ...
    private readonly string launcherPath = "Assets/Forst/Conifers [BOTD]/Installer/Editor/LaunchConifersInstaller";
    ...
    public void OnGUI()
    {
        ...
        GUILayout.Space(4);
        if (GUILayout.Button("Install selected package", GUILayout.Height(28))) InstallPackage();
        ...
        GUI.enabled = true;
        if (!File.Exists(launcherPath + ".cs")) GUI.enabled = false;
