...
inline half3 BRDF_Unity_Indirect(half3 baseColor, half3 specColor, half oneMinusReflectivity, half oneMinusRoughness,
                                 half3 normal, half3 viewDir, half occlusion, UnityGI gi)
{
    half3 c = 0;
...
inline half4 LightingStandardTranslucent(SurfaceOutputStandardTranslucent s, half3 viewDir, UnityGI gi)
{
    ...
    half4 c = UNITY_BRDF_PBS(s.Albedo, s.Specular, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir, gi.light,
                             gi.indirect);
...
inline half4 LightingStandardTranslucent_Deferred(SurfaceOutputStandardTranslucent s, half3 viewDir, UnityGI gi,
