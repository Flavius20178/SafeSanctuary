...
namespace sc.terrain.proceduralpainter
{
    public class Noise : Modifier
    {
        ...
        [Attributes.MinMaxSlider(0f, 1f)] public Vector2 levels = new(0.5f, 1f);
        ...
        public override void Configure(Material material)
        {
            ...
            material.SetVector("_NoiseScaleOffset",
                new Vector4(noiseScale * 0.001f, noiseScale * 0.001f, noiseOffset.x, noiseOffset.y));
